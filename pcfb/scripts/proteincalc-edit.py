...
AminoKeys2 = [89.09, 174.20, 132.12, 133.10,121.15]
AminoValues2 = ['A', 'R', 'N', 'D', 'C']

AminoDict2 = dict(zip(AminoKeys2, AminoValues2))

ProteinSeq2 = "ANDRNADCAAN"
MolWeight2 = 0

for AminoAcid2 in ProteinSeq2:
	# look up the value corresponding to the current amino acid
	# add its value of the present amino acid to the running total
	MolWeight2 = MolWeight2 + AminoDict2[AminoAcid2]

print "Protein:", ProteinSeq2
print "Molecular weight: %.1f" % (MolWeight2)
