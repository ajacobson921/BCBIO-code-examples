#!/usr/bin/env python
# Code borrowed from https://github.com/jayunit100/RudolF/blob/master/bioscripts/needleman-wunsch.py
from sys import *
seq1='GTCTATCGTAGGAATTTCGGATCGTG'
seq2='CCCAAGGTTCGAACGTCCGGATAGCC'
